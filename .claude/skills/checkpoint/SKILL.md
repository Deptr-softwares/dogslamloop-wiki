...
| A rule that should hold in *every* future session | `CLAUDE.md`, or the relevant skill — **not** memory |
...
Anything a future session must not get wrong belongs in `CLAUDE.md` or a skill,
